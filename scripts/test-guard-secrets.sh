...
deny 'certs/dist.p12'                        # PKCS#12 key/cert bundle
deny 'CERTS/DIST.P12'                        # case-insensitive
deny 'build/App_Dev.mobileprovision'         # Apple provisioning profile (signing identity)
...
allow 'notes/p12-format.md'                  # *.p12 is suffix-anchored
allow 'docs/mobileprovision-guide.md'        # *.mobileprovision is suffix-anchored
